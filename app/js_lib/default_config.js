...
export const defaultConfig_asdf = {
    "mapservers": [
        {
            "identity": "local-mapserver",
            "domain": "http://localhost:8080",
    ...
    // Only for exporting/importing.  
    // Convert `legacy-trust-preferences` sub-objects (domain preferences) to
    // Map-Objects internally, so that the entries have an ordering.  
    // Neccessary (not really, but..) for first-match strategy
    "legacy-trust-preference-prios": {
        "*": [
            "All Trust-Store CAs"
        ]
